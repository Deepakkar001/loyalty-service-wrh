package com.loyaltyos.rules.cache;
...
public class CachedActionSnapshot {
    ...
    public CachedActionSnapshot(String actionUid, String actionType, String formula, JsonNode config) {
    ...
    public static final class Builder {
        ...
        public CachedActionSnapshot build() { return new CachedActionSnapshot(actionUid, actionType, formula, config); }
    }
