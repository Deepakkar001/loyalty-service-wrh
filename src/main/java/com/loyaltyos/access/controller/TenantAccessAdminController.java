...
public class TenantAccessAdminController {
    ...
    @GetMapping("/roles")
    @PreAuthorize("hasPermission('team_admin.view')")
    ...
    @PostMapping("/roles")
    @PreAuthorize("hasPermission('team_admin.create')")
    ...
    @PreAuthorize("hasPermission('team_admin.delete')")
    ...
    @PreAuthorize("hasPermission('team_admin.edit')")
